  ...
  theme: {
    ...
    extend: {
      ...
      boxShadow: {
        ...
        floating:
          "0 20px 25px -5px hsl(var(--shadow-color) / 0.10), 0 10px 10px -5px hsl(var(--shadow-color) / 0.04)",
        glow: "0 0 0 1px hsl(var(--primary) / 0.15), 0 8px 30px -8px hsl(var(--primary) / 0.40)",
      },
      backgroundImage: {
        "gradient-radial":
          "radial-gradient(ellipse at top, hsl(var(--gradient-from) / 0.20), transparent 60%)",
        "gradient-mesh":
